-- finalizar_pedido v5 — adiciona p_taxa_entrega para pedidos PDV com entrega domiciliar.
-- Caso de uso: lojista anota pedido por telefone de cliente que não pode sair de casa.
...
BEGIN
  ...
  ELSIF p_tipo = 'pdv' THEN
    -- PDV: lojista pode informar taxa manual (entrega domiciliar por telefone)
...
GRANT EXECUTE ON FUNCTION public.finalizar_pedido(uuid,text,text,text,text,text,text,text,uuid,jsonb,double precision,double precision,text,text,text,numeric,numeric) TO anon, authenticated;
