-- Corrige finalizar_pedido: combina numero-por-empresa (v5 de 20260617120000)
-- com user_id + fluxo_pedido + status inicial (de 20260618200000).
-- A migration anterior sobrescreveu errado sem o numero no INSERT.
...
BEGIN
  ...
  -- ── 1. Valida empresa, obtém próximo número e fluxo_pedido atomicamente ───────
  ...
  -- ── 7. Insere pedido com número sequencial por empresa ────────────────────────
