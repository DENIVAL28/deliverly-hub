  ...
  if (!aberto) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full bg-orange-500 hover:bg-orange-600 text-white shadow-2xl hover:scale-105 transition-transform ring-2 ring-white"
